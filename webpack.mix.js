...
mix
    ...
    .purgeCss({
        ...
        whitelist: ['is-active', 's1', 'bg-s1', 'bg-s1-light', 's2', 'bg-s2', 'bg-s2-light', 's3', 'bg-s3', 'bg-s3-light', 's4', 'bg-s4', 'bg-s4-light', 's5', 'bg-s5', 'bg-s5-light', 's6', 'bg-s6', 'bg-s6-light', 's7', 'bg-s7', 'bg-s7-light', 's8', 'bg-s8', 'bg-s8-light', 'buttonlink']
    })
    .version()
